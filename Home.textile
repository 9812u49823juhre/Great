...
This category of 0-click involves getting the data (through scraping or from a dump) and then putting it in a form we can use. You could really do it in any language. Most of our stuff internally is in Perl, and the above examples are in Python.
